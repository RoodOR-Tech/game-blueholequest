...
export const LOCATION_ROUTES: readonly LocationRoute[] = [
  {
    ...
    events: [
      event(
        ...
        'calamity',
        'FLOODED UNDERPASS',
        'Storm water covers the road ahead.',
        'WADE THROUGH',
      ...
      event(
        ...
        'environment',
        'BLACKBERRY THICKET',
        'Thorny vines have swallowed the trail.',
        'CUT A PATH',
        'FOLLOW THE DEER TRACK',
      ),
      event(
        'construction_detour',
        'environment',
        'CONSTRUCTION DETOUR',
        'Broken concrete and equipment block the way.',
        'SCRAMBLE OVER',
        'SEARCH FOR A SIDE ROAD',
      ),
    ],
  },
  {
    ...
    events: [
      event(
        ...
        'calamity',
        'ICE STORM',
        'Freezing rain turns the route into glass.',
        'CROSS QUICKLY',
        'WAIT UNDER COVER',
      ),
      event(
        ...
        'environment',
        'POWER CORRIDOR',
        'Fallen branches spark beside the path.',
        'DASH THROUGH',
        'CIRCLE AROUND',
      ),
      event(
        ...
        'environment',
        'WETLANDS CROSSING',
        'Deep mud hides the safest footing.',
        'LEAP THE POOLS',
        'TEST EACH STEP',
      ),
    ],
  },
  {
    ...
    events: [
      event(
        ...
        'calamity',
        'WILLAMETTE FLOOD',
        'The river has surged across the low road.',
        'FORD THE WATER',
        'BUILD A RAFT',
      ),
      event(
        ...
        'environment',
        'RIVERBANK TRAIL',
        'A washed-out bank narrows to a ledge.',
        'EDGE ACROSS',
        'CLIMB ABOVE IT',
      ),
      event(
        ...
        'environment',
        'RAIL YARD',
        'Parked freight cars form a steel maze.',
        'CLIMB BETWEEN CARS',
        'FOLLOW THE SIGNALS',
      ),
    ],
  },
  {
    ...
    events: [
      event(
        ...
        'calamity',
        'DUST STORM',
        'A wall of dust erases the horizon.',
        'PRESS FORWARD',
        'MAKE A SHELTER',
      ),
      event(
        ...
        'environment',
        'WHEAT FIELD',
        'The wind has flattened every landmark.',
        'FOLLOW THE WIND',
        'MARK A COMPASS LINE',
      ),
      event(
        ...
        'environment',
        'VINEYARD MAZE',
        'Endless rows twist toward the hills.',
        'CUT BETWEEN ROWS',
  ...
  },
  {
    ...
    events: [
      event(
        ...
        'calamity',
        'WILDFIRE SMOKE',
        'Smoke rolls across the high desert.',
        'RUN THE CLEARING',
        'WRAP UP AND WAIT',
      ),
      event(
        ...
        'environment',
        'LAVA FIELD',
        'Jagged black rock tears at every step.',
        'BOUND ACROSS',
        'FIND THE OLD FLOW',
      ),
      event(
        ...
        'environment',
        'DESERT CANYON',
        'A narrow canyon channels fierce wind.',
        'CLIMB THE RIDGE',
        'TAKE THE CANYON FLOOR',
      ),
    ],
  },
] as const;
